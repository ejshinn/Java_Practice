public class DefaultExtendsEx {
    public static void main(String [] args) {
        ...
        ChildInter1 ci1 = new ChildInter1() {
            // ParentInter에서 상속받은 추상 메서드를 오버라이딩하여 사용
            @Override
            public void method1() {
                System.out.println("ci1의 method1()");
            }

            // ChildInter1에서 상속받은 추상 메서드를 오버라이딩
            @Override
            public void method3() {
        ...
        ChildInter2 ci2 = new ChildInter2() {
            ...
            // ParentInter에서 상속받은 디폴트 메서드를 ChildInter2에서 오버라이딩하여 추상메서드로 변환
            // ChildInter2에서 상속받은 추상 메서드를 오버라이딩하여 사용
            @Override
            public void method2() {
                System.out.println("ci2의 method2()");
            }
            // ChildInter2에서 상속받은 추상 메서드를 오버라이딩
            @Override
            public void method3() {
        ...
        ChildInter3 ci3 = new ChildInter3() {
            ...
            // ParentInter에서 상속받은 디폴트 메서드를 오버라이딩하여 디폴트 메서드의 내용을 새로 수정
            // ChildInter3에서는 오버라이딩된 디폴트 메서드를 자식 클래스에게 상속해줌

            // ChildInter3에서 상속받은 추상 메서드를 오버라이딩
            @Override
            public void method3() {
