...
public class ArrayCopyEx {
    public static void main(String[] args) {
        ...
        System.out.println("\n----- arraycopy()로 복사 -----\n");
        // System.arraycopy() : 자바의 System 클래스에서 제공하는 배열 복사 메서드
        // 5개의 매개변수를 사용함
        // 첫 번째 매개변수로 원본 배열을 지정, 두 번째 매개변수로 원본 배열에서 복사 시작 index, 세 번째 매개변수로 사본 배열을 지정, 네 번째 매개변수로 복사를 받을 index를 지정, 다섯 번째 매개변수로 복사할 크기를 지정
        ...
        // 사용법 : int[] 배열명 = Arrays.copyOf(원본 배열, 복사할 크기);

        // copyOfRange() : 원본의 내용을 지정한 위치에서 지정한 위치만큼 복사, 복사 시작 index와 복사 완료 index를 지정할 수 있음
        // 사용법 : int[] 배열명 = Arrays.copyOfRange(원본 배열, 복사 시작 index, 복사 완료 index);
