...
public class quiz {
    public static void quiz1() {
        ...
        // 객체 mySong의 인스턴스 멤버 중 getTitle() 메서드를 사용
        System.out.println("나의 노래는 " + mySong.getTitle());
    ...
    public static void quiz3() {
        ...
        // Rect 클래스 타입의 배열을 생성한 것이지 Rect 클래스 타입의 객체를 생성한 것은 아님, Rect 클래스 타입의 배열 요소는 현재 모두 null임
        ...
        // for 문을 통해서 Rect 클래스 타입의 배열이 가지고 있는 모든 데이터 출력
        for (int i = 0; i < rect.length; i++) {
